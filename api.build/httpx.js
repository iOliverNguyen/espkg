...
exports.errorContent = exports.responseError = exports.redirect = exports.response = exports.fetchJson = exports.sendResponse = exports.isResponse = exports.ResponseData = void 0;
...
function response(code, body) {
    return new ResponseData({ code: code, body: body });
}
...
function responseError(code, err, msg, extra) {
    return new ResponseData({
        code: code,
        body: __assign({ error: errorContent(err), msg: msg }, extra),
    });
}
